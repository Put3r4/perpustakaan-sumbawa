...
interface Summary {
    ...
    total_denda_keseluruhan: number;
}

interface LaporanDendaProps {
    transaksi: Transaksi[];
    filter: Filter;
    summary: Summary;
}

export default function LaporanDenda({ transaksi, filter, summary }: LaporanDendaProps) {
    ...
    return (
        <>
            <Head title="Laporan Denda - Perpustakaan Kota Sumbawa" />
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mt-1">
                                    Akumulasi denda lunas dan piutang berjalan
                                </p>
                            </div>
                ...
                <main className="container mx-auto px-4 py-8">
                        ...
                        <form onSubmit={handleFilter} className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-end">
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="w-full px-6 py-3 bg-yellow-600 text-white font-semibold rounded-lg hover:bg-yellow-700 transition duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-3xl font-bold text-blue-600 mt-2">
                                        {formatCurrency(summary.total_denda_lunas)}
                                    </h3>
                                    <p className="text-xs text-gray-500 mt-1">Denda Telah Diterima</p>
                                </div>
                                <div className="text-5xl opacity-20">✅</div>
                            </div>
                        </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    ...
                                    <h3 className="text-3xl font-bold text-yellow-600 mt-2">
                                        {formatCurrency(summary.total_denda_keseluruhan)}
                                    </h3>
                                    <p className="text-xs text-gray-500 mt-1">Lunas + Piutang</p>
                                </div>
                                <div className="text-5xl opacity-20">💰</div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <a
                                href={`/admin/laporan/denda/pdf?tanggal_mulai=${data.tanggal_mulai}&tanggal_akhir=${data.tanggal_akhir}`}
                                target="_blank"
                            ...
                            <a
                                href={`/admin/laporan/denda/excel?tanggal_mulai=${data.tanggal_mulai}&tanggal_akhir=${data.tanggal_akhir}`}
                                            ...
                                            return (
                                                <tr
                                                    ...
                                                    className={`hover:bg-yellow-50 transition-colors ${
                                                        item.StatusBayarDenda === 'Belum_Lunas'
                                                            ? 'bg-red-50'
                                                            : ''
                                                    }`}
                                                >
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-center">
                                                        <span className="px-3 py-1 text-sm font-bold rounded-full bg-orange-100 text-orange-800">
                                                            {Math.round(item.hari_terlambat)} hari
                                                        </span>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-yellow-700">
                                                        {formatCurrency(item.denda_realtime)}
                                                    </td>
                                            ...
                                            <td colSpan={9} className="px-6 py-12 text-center">
                                                <div className="text-gray-500">
                                                    ...
                                                    <p className="text-sm mt-1">
                                                        Belum ada transaksi denda pada rentang tanggal ini
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div className="container mx-auto px-4">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-gray-400 mt-2">
                                Laporan Denda - Dinas Perpustakaan dan Kearsipan
                            </p>
                        </div>
                    </div>
                </footer>
