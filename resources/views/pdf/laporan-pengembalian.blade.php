...
<body>
    ...
    <div class="summary-box">
        ...
        <p><strong>Total Denda:</strong> Rp {{ number_format($summary['total_denda'], 0, ',', '.') }}</p>
        <p><strong>Denda Lunas:</strong> Rp {{ number_format($summary['total_lunas'], 0, ',', '.') }}</p>
        <p><strong>Piutang Denda:</strong> Rp {{ number_format($summary['total_denda'] - $summary['total_lunas'], 0, ',', '.') }}</p>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $item->TglKembali ? \Carbon\Carbon::parse($item->TglKembali)->format('d/m/Y') : '-' }}</td>
                ...
                <td class="text-center">{{ $item->StatusBayarDenda }}</td>
            </tr>
            @empty
            <tr>
            ...
            <tr class="total-row">
                <td colspan="8" class="text-right"><strong>TOTAL DENDA:</strong></td>
                <td class="text-right"><strong>{{ number_format($summary['total_denda'], 0, ',', '.') }}</strong></td>
                <td></td>
            </tr>
            @endif
        </tbody>
