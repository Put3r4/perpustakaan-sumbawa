...
class TransaksiNonPelajar extends Model
{
    ...
    protected static function booted(): void
    {
        static::creating(function (self $model) {
            if (empty($model->NoPinjamN)) {
                $model->NoPinjamN = (string) Str::uuid();
            }
        });
    }

    /**
     * Relationship to AnggotaNonPelajar.
     *
     * @return BelongsTo<AnggotaNonPelajar, $this>
     */
    public function anggotaNonPelajar()
    {
        return $this->belongsTo(AnggotaNonPelajar::class, 'NoAnggotaN', 'NoAnggotaN');
    }
